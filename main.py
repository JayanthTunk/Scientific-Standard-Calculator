...
root = Tk()
root.title("Jayanth's Scientific Calculator")
root.configure(background = 'white')
root.resizable(width=False, height=False)
root.geometry("498x520+480+90")
calc = Frame(root)
calc.grid()
...
btnZero = Button(calc, text="0",width=6,
				height=2,bg='cornflower blue',fg='white',
				font=('Helvetica',20,'bold'),
...
btnPM = Button(calc, text=chr(177),width=6,
			height=2,bg='medium blue', font=('Helvetica',20,'bold'),
...
btnPi = Button(calc, text="pi",width=6,
			height=2,bg='medium blue',fg='white',
			font=('Helvetica',20,'bold'),
...
lblDisplay = Label(calc, text = "Jayanth's Scientific Calculator",
...
def Scientific():
	root.resizable(width=False, height=False)
	root.geometry("995x520+0+0")


def Standard():
	root.resizable(width=False, height=False)
	root.geometry("498x520+0+0")
